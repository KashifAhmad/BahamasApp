class GetSpecificBusinessModel {
  String? message;
  int? status;
  bool? success;
  Data? data;

  GetSpecificBusinessModel(
      {this.message, this.status, this.success, this.data});

  GetSpecificBusinessModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.analytics != null) {
      data['reviews'] = this.analytics!.map((v) => v.toJson()).toList();
    }
...
class Reviews {
  ...
  Reviews.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    userId1 =
        json['userId'] != null ? UserDetail.fromJson(json['userId']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.userId1 != null) {
      data['reviewUserId'] = this.userId1!.toJson();
    }
...
class UserDetail {
  ...
  UserDetail({this.sId, this.fullName, this.image});
